...
namespace TopsisLIB
{
    public class DataProccessModel
    {
        ...
        public DataProccessModel(List<Criteria> criterias, List<Alternatif> alternatives)
        {
            ...
            {
                ListBobot.Add(new Bobot { A = "A" + n, C = "C1", Value = i.Harga });
                ListBobot.Add(new Bobot { A = "A" + n, C = "C2", Value = i.Hardisk });
                ListBobot.Add(new Bobot { A = "A" + n, C = "C3", Value = i.ProccesorCode });
                ListBobot.Add(new Bobot { A = "A" + n, C = "C4", Value = i.RAMCode });
                ListBobot.Add(new Bobot { A = "A" + n, C = "C5", Value = i.LCD });
                n++;
